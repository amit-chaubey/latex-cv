...
% \textbf{BRILLIANT MINDS TUITION LTD} \hfill Liverpool, UK \\
% \textit{Tutor} \hfill November 2023 - August 2024
% \begin{itemize}[left=0pt, itemsep=0pt]
%     \item Planning and delivering high-quality, engaging, and effective lessons in alignment with the national curriculum.
% \end{itemize}
...
% \textbf{ALLEN  CAREER INSTITUTE PVT LTD} \hfill Bengaluru, IND \\
% \textit{Physics Faculty} \hfill October 2014 - March 2021
% \begin{itemize}[left=0pt, itemsep=0pt]
% \item Taught classes while managing data-driven customized teaching for over 5,000 students, established new study centres, and organised parent-teacher meetings, enhancing student enrolment and placements in premier institutes.

% \end{itemize}

% \section*{Leadership \& Teaching}

% % \textbf{CORNER HOUSE} \hfill Bengaluru, IND \\
% % \textit{Front-end member} \hfill June 2021 - November 2021
% \begin{itemize}[left=0pt, itemsep=0pt]
%     \item Organised marketing and advertising campaign for CORNER HOUSE, resulting in a 20\% increase in membership. 
%     \item Event Organiser of EIEIA-13, Electronics and Instrumentation Dept. Fest, 2013.
%     \item Taught Physics at Allen Career institute over 6 years while managing data-driven customized teaching for over 5,000 students, established new study centres, and organised parent-teacher meetings, enhancing student enrolment.
%     \item Planning and delivering high-quality, engaging, and effective Physics and Maths lessons in alignment with the national curriculum in liverpool \& London as a part of social giveback 
% \end{itemize}
...
% \textbf{HARVARD COLLEGE MARATHON CHALLENGE} \hfill Cambridge, MA \\
% \textit{Training Program Director} \hfill January - May 2021
% \begin{itemize}[left=0pt, itemsep=0pt]
%     \item Developed training program for 25 charity runners.
%     \item Raised over \$25,000 to support Phillips Brooks House Association and The Cambridge Food Project.
% \end{itemize}
